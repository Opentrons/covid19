...
def run(protocol):
    ...
    reagentrack = protocol.load_labware(
        ...
        '2', 'Opentrons 24 TubeRack with Reagents')
    ...
    magsamps_single = [
        magplate[ltr+n] for n in ['1', '3', '5'] for ltr in 'ABCDEFGH']
    ...
    # Transfer magbeads
    p300_single.pick_up_tip(tips_single['H12'])
    p300_single.aspirate(150, magbeads)
    for _ in range(20):
        p300_single.dispense(130, magbeads.bottom(6))
