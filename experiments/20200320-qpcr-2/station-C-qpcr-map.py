metadata = {
    'protocolName': 'BP Genomics Station C: 20200320 qPCR Test 2',
...
MASTER_MIX_MAP = '''
Endogenous	Reaction	Reaction									Reaction
Endogenous	Reaction	Reaction									Reaction
Endogenous	Reaction	Reaction									Reaction
Endogenous	Reaction	Reaction									Reaction
Endogenous	Reaction	Reaction									Reaction
Endogenous	Reaction	Reaction									Reaction
Endogenous	Reaction	Reaction									Reaction
Endogenous	Reaction	Reaction								Reaction	Reaction
'''

SAMPLE_MAP = '''
Sample 1	Sample 1	Sample 1									PCD 1
Sample 2	Sample 2	Sample 2									PCD 2
Sample 3	Sample 3	Sample 3									PCD 3
Sample 4	Sample 4	Sample 4									PCD 4
Sample 5	Sample 5	Sample 5									PCD 5
Sample 6	Sample 6	Sample 6									PCD 6
Sample 7	Sample 7	Sample 7									PCD 7
Sample 8	Sample 8	Sample 8								Water	PCD 8
'''
