metadata = {
    'protocolName': 'BP Genomics Station C: Zymo Extraction',
...
MASTER_MIX_MAP = '''
Reaction	Reaction		Thermo	Thermo		Reaction			Thermo		Reaction
Reaction	Reaction		Thermo	Thermo		Reaction			Thermo		Reaction
Reaction	Reaction		Thermo	Thermo		Reaction			Thermo		Reaction
Reaction	Reaction		Thermo	Thermo		Thermo			Thermo		Reaction
Reaction	Reaction		Thermo	Thermo		Thermo			Thermo		Reaction
Reaction	Reaction		Thermo	Thermo		Thermo			Thermo		Reaction
Reaction	Reaction		Thermo	Thermo					Thermo		Reaction
Reaction	Reaction		Thermo	Thermo					Thermo		Reaction
'''

SAMPLE_MAP = '''
Sample 1	Sample 9		Sample 1	Sample 9		Negative			PCD 1		PCD 1
Sample 2	Sample 10		Sample 2	Sample 10		Negative			PCD 2		PCD 2
Sample 3	Sample 11		Sample 3	Sample 11		Negative			PCD 3		PCD 3
Sample 4	Sample 12		Sample 4	Sample 12		Negative			PCD 4		PCD 4
Sample 5	Sample 13		Sample 5	Sample 13		Negative			PCD 5		PCD 5
Sample 6	Sample 14		Sample 6	Sample 14		Negative			PCD 6		PCD 6
Sample 7	Sample 15		Sample 7	Sample 15					PCD 7		PCD 7
Sample 8	Sample 16		Sample 8	Sample 16					PCD 8		PCD 8
'''
